package com.fosanzdev.BlackJack.Estadisticas;
...
public class Estadisticas {
    ...
    /**
     * M�todo para guardar las estad�sticas en un archivo.
     *
     * @param archivoEstadisticas El nombre del archivo de estad�sticas.
